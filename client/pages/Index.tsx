...
export default function Index() {
  ...
  return (
    <>
        ...
        <div className="container grid gap-10 py-16 md:grid-cols-2 md:gap-8 md:py-24 items-center">
          <div>
            ...
            <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
              Thuê Xe Điện{" "}
              <span className="text-emerald-400">Lái Tương Lai</span>
            </h1>
            <p className="mt-4 text-white/80">
              Truy cập xe điện cao cấp tại các trạm khắp thành phố. Bền vững,
              giá dễ chịu và luôn sẵn sàng cho hành trình của bạn.
            </p>
            <ul className="mt-6 grid grid-cols-2 gap-2 text-sm text-white/80 sm:max-w-md">
              <li className="flex items-center gap-2">
                <ShieldCheck className="h-4 w-4 text-emerald-500" /> Bảo hiểm
                toàn diện
              </li>
              <li className="flex items-center gap-2">
                <BatteryCharging className="h-4 w-4 text-emerald-500" /> Sạc
                miễn phí
              </li>
              <li className="flex items-center gap-2">
                <Leaf className="h-4 w-4 text-emerald-500" /> Không khí sạch
              </li>
              <li className="flex items-center gap-2">
                <Car className="h-4 w-4 text-emerald-500" /> Xe đời mới
              </li>
            </ul>
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <a
                href="#tim-tram"
                className="inline-flex items-center gap-2 rounded-md bg-primary px-4 py-2 font-semibold text-primary-foreground shadow-lg shadow-emerald-200/50 hover:shadow-emerald-300/60"
              >
                <MapPin className="h-4 w-4" /> Tìm Trạm Xe
              </a>
              <a
                href="#huong-dan"
                className="inline-flex items-center gap-2 rounded-md border px-4 py-2 text-sm font-medium text-white/90 hover:bg-white/10"
              >
                Cách Thức Hoạt Động
              </a>
            </div>
          ...
          <div className="relative">
            ...
            <form
              onSubmit={submit}
              className="relative rounded-2xl border border-white/10 bg-slate-900/80 p-6 text-white shadow-xl backdrop-blur dark:border-border dark:bg-card/80 dark:text-foreground"
            >
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <label className="grid gap-1 text-sm">
                  <span className="flex items-center gap-2 text-foreground/80">
                    <MapPin className="h-4 w-4" /> Điểm đón
                  </span>
                  <select
                    value={pickup}
                ...
                <label className="grid gap-1 text-sm">
                  <span className="flex items-center gap-2 text-foreground/80">
                    <MapPin className="h-4 w-4" /> Điểm trả
                  </span>
                  <select
                    value={dropoff}
                ...
                <label className="grid gap-1 text-sm sm:col-span-2">
                  <span className="flex items-center gap-2 text-foreground/80">
                    <Calendar className="h-4 w-4" /> Ngày nhận xe
                  </span>
                  <input
                    type="date"
                    required
              ...
              <button
                type="submit"
                className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-md bg-primary px-4 py-2.5 font-semibold text-primary-foreground shadow-lg shadow-emerald-200/60 hover:shadow-emerald-300/60"
              >
                Tìm xe phù hợp <ChevronRight className="h-4 w-4" />
              </button>
              <p className="mt-2 text-center text-xs text-foreground/70">
                Không phí ẩn, hủy miễn phí trong 24h
              </p>
            </form>
          </div>
        </div>
      ...
      <section
        id="tim-tram"
        className="bg-gradient-to-b from-muted/60 to-transparent py-16 sm:py-24"
      >
        <div className="container">
          <SectionTitle
            eyebrow="Đặt xe"
            title="Tìm điểm thuê trên bản đồ & xe có sẵn"
          />
            ...
            <div className="lg:col-span-2 overflow-hidden rounded-2xl border bg-card">
              ...
              <div className="border-t p-4">
                <div className="flex items-center gap-2 text-sm text-foreground/70">
                  <MapPin className="h-4 w-4" /> Gợi ý địa điểm gần bạn: THH ĐÔ,
                  Dịch Vọng Hậu
                </div>
              </div>
            </div>
              ...
              {cars.map((c, i) => (
                ...
                >
                  ...
                  <div className="mt-3 flex items-center justify-end gap-2">
                    <button className="inline-flex items-center justify-center rounded-md bg-primary px-3 py-2 text-xs font-semibold text-primary-foreground">
                      Đặt xe ngay
                    </button>
                    <button className="inline-flex items-center justify-center rounded-md border px-3 py-2 text-xs font-medium hover:bg-muted">
                      Chi tiết
                    </button>
                  </div>
                </div>
        ...
        <div className="mx-auto mt-10 max-w-4xl overflow-hidden rounded-2xl border bg-card">
          <ul className="divide-y">
            <li className="flex items-start gap-4 p-5 sm:p-6">
              <span className="mt-1 grid h-7 w-7 place-items-center rounded-full bg-emerald-500 text-xs font-bold text-white">
                01
              </span>
              <div className="flex-1">
                <h3 className="flex items-center gap-2 text-base font-semibold">
                  <QrCode className="h-5 w-5 text-emerald-600" /> Check-in tại
                  quầy/ứng dụng
                </h3>
                <p className="mt-1 text-sm text-foreground/70">
                  Quét mã đặt xe để xác nhận thông tin tài khoản.
                </p>
              </div>
            ...
            <li className="flex items-start gap-4 p-5 sm:p-6">
              ...
              <div className="flex-1">
                <h3 className="flex items-center gap-2 text-base font-semibold">
                  <FileSignature className="h-5 w-5 text-emerald-600" /> Ký hợp
                  đồng điện tử
                </h3>
                <p className="mt-1 text-sm text-foreground/70">
                  Xem kỹ điều khoản, ký nhanh trên điện thoại hoặc máy tính
                  bảng.
                </p>
              </div>
            </li>
            ...
            <li className="flex items-start gap-4 p-5 sm:p-6">
              ...
              <div className="flex-1">
                <h3 className="flex items-center gap-2 text-base font-semibold">
                  <Handshake className="h-5 w-5 text-emerald-600" /> Bàn giao
                  cùng nhân viên
                </h3>
                <p className="mt-1 text-sm text-foreground/70">
                  Kiểm tra tình trạng xe và chụp ảnh trước khi nhận khóa.
                </p>
              </div>
            </li>
            ...
            <li className="flex items-start gap-4 p-5 sm:p-6">
              ...
              <div className="flex-1">
                <h3 className="flex items-center gap-2 text-base font-semibold">
                  <MapPin className="h-5 w-5 text-emerald-600" /> Trả xe đúng
                  điểm và hoàn tất thanh toán
                </h3>
                <p className="mt-1 text-sm text-foreground/70">
                  Trả xe tại đúng điểm đã thuê để tránh phụ phí.
                </p>
              </div>
            </li>
          </ul>
          ...
          <div className="mx-auto mt-8 max-w-4xl rounded-2xl border bg-card p-4 sm:p-6">
            <ol className="relative mx-1 space-y-6 sm:space-y-8 before:absolute before:left-4 before:top-0 before:bottom-0 before:w-px before:bg-emerald-100">
              <li className="relative pl-10">
                <span className="absolute left-0 top-0 grid h-8 w-8 place-items-center rounded-full bg-emerald-500 text-xs font-bold text-white">
                  01
                </span>
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1">
                    <h3 className="flex items-center gap-2 text-base font-semibold">
                      <MapPin className="h-5 w-5 text-emerald-600" /> Trả xe
                      đúng điểm thuê
                    </h3>
                    <p className="mt-1 text-sm text-foreground/70">
                      Trả xe tại đúng điểm đã thuê để tránh phụ phí.
              ...
              <li className="relative pl-10">
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1">
                    <h3 className="flex items-center gap-2 text-base font-semibold">
                      <CheckCircle2 className="h-5 w-5 text-emerald-600" /> Kiểm
                      tra & xác nhận tình trạng
                    </h3>
                    <p className="mt-1 text-sm text-foreground/70">
                      Nhân viên kiểm tra nhanh, bạn ký xác nhận biên bản bàn
                      giao.
                    </p>
                  </div>
                </div>
              ...
              <li className="relative pl-10">
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1">
                    <h3 className="flex items-center gap-2 text-base font-semibold">
                      <CreditCard className="h-5 w-5 text-emerald-600" /> Hoàn
                      tất thanh toán
                    </h3>
                    <p className="mt-1 text-sm text-foreground/70">
                      Thanh toán chi phí phát sinh (nếu có) trực tiếp tại quầy
                      hoặc trong ứng dụng.
                    </p>
                  </div>
                </div>
              ...
              <li className="relative pl-10">
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1">
                    <h3 className="flex items-center gap-2 text-base font-semibold">
                      <ReceiptText className="h-5 w-5 text-emerald-600" /> Nhận
                      biên lai / hoàn tất hợp đồng
                    </h3>
                    <p className="mt-1 text-sm text-foreground/70">
                      Nhận biên lai điện tử qua email/ứng dụng để lưu trữ minh
                      bạch.
                    </p>
                  </div>
                </div>
        ...
        <div className="container grid items-center gap-8 md:grid-cols-2">
          <div>
            ...
            <p className="mt-3 text-foreground/70">
              Đặt xe ô tô điện ngay hôm nay để cảm nhận sự êm ái, tiết kiệm và
              hiện đại.
            </p>
          </div>
          <div className="flex justify-end">
            <a
              href="#"
              className="inline-flex items-center gap-2 rounded-md bg-primary px-5 py-3 font-semibold text-primary-foreground shadow-lg shadow-emerald-200/60 hover:shadow-emerald-300/60"
            >
              Bắt đầu đặt xe
            </a>
          </div>
